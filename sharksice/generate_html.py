    ...
    <div class="container">
        ...
        <div class="content">
            <div class="problem-section">
                <h2>The Problem</h2>
                <p>Have you ever been frustrated not being able to find a convenient way to keep track of all the events at Sharks Ice? This project provides downloadable calendar files (.ics format) that you can import into your favorite calendar app (Google Calendar, Apple Calendar, Outlook, etc.) to stay updated on all events.</p>
            </div>
